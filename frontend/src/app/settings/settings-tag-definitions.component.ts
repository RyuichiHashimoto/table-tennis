...
import { RallyTagDefinition } from '../shared/models';

@Component({
  selector: 'app-settings-tag-definitions',
  standalone: true,
  imports: [CommonModule, FormsModule, ConfirmModalComponent],
  templateUrl: './settings-tag-definitions.component.html',
  styleUrl: './settings-tag-definitions.component.css',
})
export class SettingsTagDefinitionsComponent implements OnInit {
