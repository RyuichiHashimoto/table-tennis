...
import { MatchVideoPanelComponent } from '../components/match-video-panel/match-video-panel.component';
import { MatchStatusPanelComponent } from '../components/match-status-panel/match-status-panel.component';
import { MatchRecordControlsComponent } from '../components/match-record-controls/match-record-controls.component';
import { SelectedEventPanelComponent } from '../components/selected-event-panel/selected-event-panel.component';
