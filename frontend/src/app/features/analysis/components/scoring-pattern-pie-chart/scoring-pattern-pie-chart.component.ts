...
import { ScoringPatternSlice } from '../../../table-tennis/models/models';
...
export class ScoringPatternPieChartComponent implements AfterViewInit, OnChanges, OnDestroy {
  ...
  private renderChart(): void {
    ...
    const cardBackground = styles.getPropertyValue('--bg-card').trim() || '#ffffff';
    const textColor = styles.getPropertyValue('--text-main').trim() || '#14231d';
